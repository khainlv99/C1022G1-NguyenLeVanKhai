                ...
                <div class="col-md-12">
                    <div class="container-inner">
                        <ul>
                            ...
                            @if(isset($cateProduct->c_ten))
                            <li class="category3"><span>{{$cateProduct->c_ten}}</span></li>
                            @endif
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="topbar-left">
                        ...
                        <aside class="sidebar-content">
                            ...
                            <ul>
                                ...
                                <li><a class="{{Request::get('price') == 6 ? 'active' : ''}}" href="{{request()->fullUrlWithQuery(['price' => 6])}}">Lớn hơn 10.000.000</a></li>
                            </ul>
                        </aside>
...
{{--                                                <span class="sale-text">Sale</span>--}}
                                                <div class="product-img">
                                                    ...
                                                    @if($product->pro_giamgia)
                                                        <span style="position: absolute;font-size: 12px;background-image: linear-gradient(-90deg,#ec1f1f 0%,#ff9c00 100%);border-radius: 10px;padding: 2px 7px;color: white;right: 5px">{{$product->pro_giamgia}} %</span>
                                                    @endif

                                                    <a href="{{route('get.detail.product',[$product->pro_slug,$product->id])}}">
                                                        <img class="primary-image" src="{{asset(pare_url_file($product->pro_hinhdaidien))}}" alt="" style="width: 330px;height: 270px" />
                                                        <img class="secondary-image" src="{{asset(pare_url_file($product->pro_hinhdaidien))}}" alt="" style="width: 330px;height: 270px" />
                                                    </a>
                                                    ...
                                                    <div class="price-box">
                                                        <span class="new-price">{{number_format($product->pro_dongia,0,',','.')}}đ</span>
                                                    </div>
                                                </div>
                                                <div class="product-content">
                                                    <h2 class="product-name" style="font-size: 14px;color: #333;display: -webkit-box;-webkit-line-clamp: 1;-webkit-box-orient: vertical;text-overflow: ellipsis;overflow: hidden;"><a href="{{route('get.detail.product',[$product->pro_slug,$product->id])}}">{{$product->pro_tensp}}</a></h2>
